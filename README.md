...
| 版本          | 文件                     | 用途                                 | 大小  |
| ------------- | ------------------------ | ------------------------------------ | ----- |
| **简单GUI版** | `bin\theme-switcher.exe` | 推荐：双击运行，对话框显示状态并切换 | 2.5MB |
...
2. 双击 `theme-switcher.exe`
3. 对话框中显示当前主题状态
4. 点击**确定**切换到另一种主题
5. 点击**取消**或**叉叉**退出（不切换主题）

**界面示例：**

![界面示例](image/image.png)
